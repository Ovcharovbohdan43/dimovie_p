...
export function RoomCatalogSetup({ roomId, onSuccess }: RoomCatalogSetupProps) {
  ...
  return (
    <div className="dm-glass w-full overflow-hidden rounded-[20px]">
      ...
      <div className="space-y-4 p-6">
        ...
        <Button
          type="button"
          className="h-11 w-full rounded-2xl bg-[#00a8e1] text-sm font-semibold text-white hover:bg-[#00a8e1]/90"
          onClick={handleLoad}
        ...
        {catalog && (
          <div className="space-y-3 rounded-2xl border border-white/[0.06] bg-black/20 p-4">
            ...
            <Button
              className="h-11 w-full rounded-2xl bg-[#e50914] hover:bg-[#f40612]"
